...
function Card(props) {
    ...
    return (
        ...
        <button
        className='w-[30px] h-[30px] absolute rounded-2xl cursor-pointer flex justify-center items-center bg-[#8c8c8c] opacity-50  self-end mr-[10px] mt-[10px] shadow-md border-[1px] border-solid ' onClick={handleBookmarkClick}>
