...
function Selling() {
  ...
  const news = [
    {
      image: "/pic1.jpg",
      content: "Chung cư và nhà ở riêng lẻ đang khởi sắc trở lại ",
      date: "6/12/2023  10:48 AM",
    },
    {
      image: "/pic2.jpg",
      content:
        "Lâm Đồng chính thức phê duyệt quy hoạch sử dụng đất đến năm 2030 của thành phố Đà Lạt",
      date: "10/11/2023  3:24 PM",
    },
    {
      image: "/pic3.jpg",
      content:
        "Quảng Nam: Hàng loạt resort, biệt thự du lịch, nhà hàng ven biển thấp thỏm nỗi lo sạt lở",
      date: "12/11/202312/11/2023  7:41 AM",
    },
    {
      image: "/pic4.jpg",
      content:
        "Hạ Long: Tiết lộ mức giá mà hai doanh nghiệp này phải trả cho 16.000m2 đất để xây khu nhà ở thương mại",
      date: "10/11/2023  10:36 AM",
    },
    {
      image: "/pic5.jpg",
      content:
        "Thứ trưởng Bộ Xây dựng nêu lý do không tăng lợi nhuận cho doanh nghiệp làm nhà xã hội",
      date: "30/09/2023  9:27 PM",
    },
    {
      image: "/pic6.jpg",
      content: "Chung cư và nhà ở riêng lẻ đang khởi sắc trở lại ",
      date: "6/12/2023  4:20 PM",
    },
  ];
  const reseller = [
    {
  ...
  return (
    <div className="flex  flex-col">
      ...
      <div className="w-full bg-gradient-green py-[15px] px-5  rounded-xl flex flex-col relative mb-10">
        <span className="text-[#29df7d] text-2xl font-semibold mb-[5px]">
          Nhà đất bán
        </span>
        <span className="text-[#099c4d] text-sm font-normal">
          Khám phá danh sách các căn hộ, biệt thự, nhà phố và đất nền đang được
          bán trên toàn quốc.
        </span>
      </div>
      {/* <FilterBar/> */}
      <div className="flex  justify-between">
       ...
       <PaginationButton
          ...
          <div className="max-w-[1000px] flex flex-col ">
            <span className="text-[#000] text-lg font-semibold mb-5">
        ...
        <div className="flex flex-col w-[243px] gap-y-[35px]">
          <div className="rounded-[20px] border-[0.5px] border-solid border-[#f5f5f5] shadow-sm flex-col flex p-5">
            <span className="text-[#806056] text-base font-semibold uppercase mb-[10px]">
              Mua bán nhà đất
            </span>
            ...
            <div className="flex flex-col gap-y-[15px]">
              {tag.map((item) => (
                <div className="flex justify-between h-6">
                  <span className="text-[#6f737E] text-[13px] font-normal">
                    {item.name}
                  </span>
                  <div className="px-[10px] py-[2px]  flex justify-center items-center rounded-md border-[0.5px] border-solid border-[#806056] text-[#806056]">
                    {item.value}
                  </div>
                </div>
              ))}
          ...
          <div className="rounded-[20px] border-[0.5px] border-solid border-[#f5f5f5] shadow-sm p-5 flex flex-col">
            <span className="text-[#806056] text-base font-semibold uppercase mb-[10px]">
              BẢN ĐỒ, THÔNG TIN QUY HOẠCH CÁC TỈNH/TP
            </span>
            <hr className="border-[#806056] mb-[15px]" />
            ...
            <a className="text-[#806056] text-sm font-normal self-center cursor-pointer">
              Xem thêm
            </a>
          </div>
          <div className="rounded-[20px] border-[0.5px] border-solid border-[#f5f5f5] shadow-sm p-5 flex flex-col">
              ...
              {news.map((item) => (
                <div className="flex flex-row gap-x-[10px]">
                  ...
                  <div className="flex flex-col overflow-hidden max-h-[57px]">
                    <span className="text-[#282E3C] text-[13px] font-medium overflow-hidden   ">
                      {item.content}
                    </span>
                    <span className="text-[#6f737E] text-[12px] font-normal">
                      {item.date}
                    </span>
                  </div>
                </div>
              ...
              {reseller.map((item) => (
                <div className="flex flex-row gap-x-[10px]">
                  ...
                  <div className="flex flex-col overflow-hidden max-h-[57px] gap-y-[5px]">
                    <span className="text-[#000] text-sm font-medium overflow-hidden   ">
                      {item.name}
                    </span>
                    <div className="flex justify-between">
                      <span className="text-[#6f737E] text-[12px] font-normal">
                      ...
                      <button onClick={handleToggleVisibility}>
                        {phoneNumbersHidden ? (
                          <FaEyeSlash className="w-4 h-3" />
                        ) : (
                          <IoEyeSharp className="w-4 h-3" />
                        )}
                      </button>
                    </div>
                  </div>
          ...
          <div className="rounded-[20px] border-[0.5px] border-solid border-[#f5f5f5] shadow-sm p-5 flex flex-col">
            ...
            <hr className="border-[#806056] mb-[15px]" />
            <div className="flex flex-col gap-y-[15px] ">
              <a className="text-[#6F737E] text-sm font-normal cursor-pointer">
                Tư vấn phong thủy
              </a>
              <a className="text-[#6F737E] text-sm font-normal cursor-pointer">
