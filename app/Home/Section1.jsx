  ...
  return (
    <section className='hero'>
      ...
      <h3 className='text-base font-bold '> Chào mừng đến với  Dream Home</h3>
        ...
        <p className='text-sm font-normal leading-[21px] '> Lorem facilisis convallis quam sit varius. Enim nibh odio phasellus sem at sed <br/> id ut arcu. In turpis tortor diam mauris mauris magna adipiscing eu. </p>
        </div>
