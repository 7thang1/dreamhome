...
function Section6() {
  ...
  const autoChangeDelay = 5000; // Khoảng thời gian tự động chuyển trang (5 giây)
      ...
      <div className='flex grid-cols-3 gap-10 py-[25px] rounded-xl '>
        {FeedBack.slice(currentIndex * itemsPerPage, (currentIndex + 1) * itemsPerPage).map((feed) => (
          <motion.div
            ...
            key={feed.id}
          >
            <img className='absolute w-[58px] h-[58px] self-end mt-[75px]' src='./feedback-image.png' alt='feedback-image' />
